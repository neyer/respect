...
"""
This 'total_implied_respect' would be a good proxy for strangers determing whether they wanted to interact with one another. It could be a good proxy for trust. 
